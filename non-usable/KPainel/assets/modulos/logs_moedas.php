<?php
    $quantidade = 100;
    $registros = $pdo->query("SELECT * FROM aa_logs_moedas")->rowCount();
...
<table width="100%">
    ...
    <?php
    $i = 1;
    $sql = $pdo->query("SELECT * FROM aa_logs_moedas ORDER BY id DESC LIMIT $inicio, $quantidade");
