<?php
    $quantidade = 20;
    $registros = $pdo->query("SELECT * FROM aa_pedidos WHERE locutor='".$aa_data['usuario']."'")->rowCount();
...
<table width="100%">
    ...
    <?php
    $i = 1;
    $sql = $pdo->query("SELECT * FROM aa_pedidos WHERE locutor='".$aa_data['usuario']."' ORDER BY id DESC LIMIT $inicio, $quantidade");
