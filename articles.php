...
<title><?php echo $Holo['name']; ?>: Cardápio de Notícias</title>
...
<div class="content-header-title">Um completo Cardápio de Notícias para você!</div>
<?php 
	$noticias = mysql_query("SELECT COUNT(*) aantalleden FROM cms_news") or die (mysql_error());
	$n = mysql_fetch_assoc($noticias);	
?>
<div class="content-header-desc">Mostrando atualmente <b>15</b> de <b><?php echo $n['aantalleden']; ?></b> notícias.</div>
</div>
<div class="home-articles">
<?php $news = mysql_query("SELECT * FROM cms_news ORDER BY id DESC LIMIT 15");
...
<div class="ha-story"><?php echo $new['shortstory'] ?></div>
<div class="fh-timestamp" style="font-size: 12px; margin-top: 4px;">Públicado por <a href="/home/<?php echo $new['author'] ?>"><span class="user-style <?php echo $authorinfo['user_style']; ?>"><?php echo $authorinfo['username']; ?></span></a>, <?php echo GetLast($new['date']); ?>.</div>
</div>
</div>
</a>
<?php } ?>
